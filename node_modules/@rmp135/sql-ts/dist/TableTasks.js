...
exports.generateInterfaceName = exports.getExtends = exports.getAdditionalProperties = exports.getAllTables = void 0;
                            ...
                            return __generator(this, function (_b) {
                                switch (_b.label) {
                                    ...
                                    case 1: return [2 /*return*/, (_a.columns = _b.sent(),
                                            _a.interfaceName = TableTasks.generateInterfaceName(table.name, config),
                                            _a.name = table.name,
                                            _a.schema = table.schema,
                                            _a.additionalProperties = TableTasks.getAdditionalProperties(table.name, table.schema, config),
                                            _a.extends = TableTasks.getExtends(table.name, table.schema, config),
                                            _a)];
                                }
                            });
                        }); }))];
...
function getAdditionalProperties(tableName, schemaName, config) {
    ...
    return (_a = config.additionalProperties[fullName]) !== null && _a !== void 0 ? _a : [];
}
...
function generateInterfaceName(name, config) {
    var interfaceNamePattern = config.interfaceNameFormat;
